...
//        self.present(alertVC, animated: true)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.destination is PopoverViewController
        {
...
//        self.data.append(Cell(title: "Mathematics", description: "content", image: "math"))
//        self.data.append(Cell(title: "Marvel Super Heros", description: "content", image: "marvel"))
//        self.data.append(Cell(title: "Science", description: "content", image: "science"))
...
//        self.list = ["Mathematics": l3, "Marvel Super Heros": l2, "Science": l1]
...
//        self.dir = filename
        do {
            try str.write(to: dir!, atomically: true, encoding: String.Encoding.utf8)
        } catch {
